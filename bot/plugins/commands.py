...
async def start(bot, update):
    ...
    buttons = [[
        ...
        InlineKeyboardButton('🔘CHANNEL🔘', url='https://t.me/CL_FilMm')
    ],[
        InlineKeyboardButton('🗣️ 𝙰𝚗𝚢 𝙳𝚘𝚞𝚋𝚝', url='https://t.me/Levinomad_TG'),
        InlineKeyboardButton('𝚄𝚙𝚍𝚊𝚝𝚎𝚜 🤖', url='https://t.me/Levinomad_TG')
    ],[
        InlineKeyboardButton('💥 𝚂𝚞𝚋𝚜𝚌𝚛𝚒𝚋𝚎 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 💥', url='https://t.me/CL_FilMm')
   ]]
...
async def about(bot, update):
    ...
    buttons = [[
        InlineKeyboardButton('👤 @𝙼𝚛𝚔_𝚈𝚃 👤', url='https://t.me/Levinomad_TG'),
        InlineKeyboardButton('@𝚂𝚔𝚙_𝙺𝚙 👤', url='https://t.me/Levinomad_TG '),
